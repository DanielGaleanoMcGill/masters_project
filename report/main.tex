...
\large \textit{A project submitted in partial fulfilment of the requirements\\ for the degree of \degreename}\\[0.3cm] % University requirement text
\textit{in the}\\[0.4cm]
...
\textbf{FNN} & \textbf{F}eedforward \textbf{N}eural \textbf{N}etwork\\
\textbf{RNN} & \textbf{R}ecurrent \textbf{N}eural \textbf{N}etwork\\
\textbf{BPTT} & \textbf{B}ack \textbf{P}ropagation \textbf{T}hrough \textbf{T}time\\
